Shader "MCS/Volund Variants/Standard Character (Legacy)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
			#pragma target 3.5
			#pragma only_renderers d3d11 d3d9 opengl glcore gles gles3
			...
			#include "Volund_UnityStandardCore_Legacy.cginc"
